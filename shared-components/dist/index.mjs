...
function ir() {
  if (Re)
    return j;
  Re = 1;
  var N = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.fragment"), _ = Object.prototype.hasOwnProperty, D = N.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, F = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(E, l, R) {
    var d, b = {}, y = null, A = null;
    R !== void 0 && (y = "" + R), l.key !== void 0 && (y = "" + l.key), l.ref !== void 0 && (A = l.ref);
    for (d in l)
      _.call(l, d) && !F.hasOwnProperty(d) && (b[d] = l[d]);
    if (E && E.defaultProps)
      for (d in l = E.defaultProps, l)
        b[d] === void 0 && (b[d] = l[d]);
    return { $$typeof: P, type: E, key: y, ref: A, props: b, _owner: D.current };
  }
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var N = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.portal"), _ = Symbol.for("react.fragment"), D = Symbol.for("react.strict_mode"), F = Symbol.for("react.profiler"), w = Symbol.for("react.provider"), E = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), R = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), y = Symbol.for("react.lazy"), A = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === _ || e === F || De || e === D || e === R || e === d || ke || e === A || Se || xe || je || typeof e == "object" && e !== null && (e.$$typeof === y || e.$$typeof === b || e.$$typeof === w || e.$$typeof === E || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var m = Object.assign, S = 0, ee, re, te, ne, ae, oe, ie;
    function ue() {
    }
...
var sr = H.exports;
const lr = () => /* @__PURE__ */ sr.jsx("button", { style: { background: "blue", color: "white" }, children: "Button 1" });
export {
  lr as PrimaryButton
};
